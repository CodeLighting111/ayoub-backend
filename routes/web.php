...
use App\Http\Controllers\Admin\ClientNotificationController;
use App\Http\Controllers\Admin\NotificationController;
use App\Http\Controllers\Admin\ProfileController;
use App\Http\Controllers\Admin\RoleController;
use App\Http\Controllers\Admin\SocialMediaAccountController;
...
Route::middleware(['auth:admin', 'admin.active'])->prefix('admin')->group(function () {
    ...
    Route::get('/social-media-accounts', [SocialMediaAccountController::class, 'index'])->name('admin.social-media-accounts.index');
    Route::get('/social-media-accounts/create', [SocialMediaAccountController::class, 'create'])->name('admin.social-media-accounts.create');
    Route::post('/social-media-accounts', [SocialMediaAccountController::class, 'store'])->name('admin.social-media-accounts.store');
    ...
    Route::get('/notifications/send', [ClientNotificationController::class, 'create'])->name('admin.notifications.send.create');
    Route::post('/notifications/send', [ClientNotificationController::class, 'store'])->name('admin.notifications.send.store');
    ...
    Route::get('/admins/{admin}', [AdminUserController::class, 'show'])->name('admin.admins.show');
    Route::patch('/admins/{admin}/status', [AdminUserController::class, 'updateStatus'])->name('admin.admins.update-status');
